// =====================================================================================
// GarageAussenSenderESPC3-Lib (code1C) - V2.0 V2.0 (Low-Power ADXL)
// -------------------------------------------------------------------------------------
// Letzte Änderung: 16. Juli 2025
// Hardware:        Waveshare ESP32-C3-Zero
// Funktion:        Ein batteriebetriebener Außensensor für eine Garage mit
//                  stromsparender Bewegungserkennung.
// Logik:
...
// - ADXL345 wird für einen manuellen Schlafmodus konfiguriert (~50µA).
// - Der ACTIVITY-Interrupt auf INT2 weckt den ESP32 bei Bewegung.
// - Der Schwellenwert für die Bewegungserkennung ist in main.cpp einstellbar.
// =====================================================================================
...
#define ADXL_ACTIVITY_THRESHOLD     18        // NEU: Schwellenwert für Bewegungserkennung (1 LSB = 62.5mg)
...
void setup() {
  ...
  configureADXL345(ADXL_ACTIVITY_THRESHOLD);
  ...
  // Lösche alle möglicherweise anstehenden Interrupts des ADXL, BEVOR wir schlafen gehen.
  clearADXLInterrupt();
  delay(10); // Eine kleine Verzögerung zur Sicherheit
